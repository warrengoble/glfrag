...
/***/ function(module, exports, __webpack_require__) {
	...
	var _glfrag = __webpack_require__(166);
	
	var _glfrag2 = _interopRequireDefault(_glfrag);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	document.addEventListener('DOMContentLoaded', function () {
	  _reactDom2.default.render(_react2.default.createElement(_glfrag2.default, { width: window.innerWidth, height: window.innerHeight }), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GLFrag = function (_React$Component) {
	  _inherits(GLFrag, _React$Component);
	
	  function GLFrag(props) {
	    _classCallCheck(this, GLFrag);
	  ...
	  _createClass(GLFrag, [{
	    ...
	    key: "setup2D",
	    value: function setup2D(gl, program) {
	    ...
	    value: function render() {
	      return _react2.default.createElement("canvas", { ref: "canvas", width: this.state.width, height: this.state.height });
	    }
	  }]);
